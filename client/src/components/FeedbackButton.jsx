              ...
              <form onSubmit={handleSubmit} className="p-4">
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-brand-blue focus:border-brand-blue dark:bg-gray-700 dark:text-white placeholder-gray-500 dark:placeholder-gray-300 text-sm"
                    disabled={submitting}
                    autoFocus
                  />
